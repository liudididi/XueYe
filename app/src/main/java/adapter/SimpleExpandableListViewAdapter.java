...
public class SimpleExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    // 大学的集合
    private List<SelectMajorBean> colleges;

    private Activity activity;


    public SimpleExpandableListViewAdapter(List<SelectMajorBean> colleges, Activity activity) {
        this.colleges = colleges;
        this.activity = activity;
    }


    public void Refresh(List<SelectMajorBean> newlist) {
        if(colleges!=null){
            colleges.clear();
    ...
    public Object getChild(int groupPosition, int childPosition) {
        return colleges.get(groupPosition).getChild().get(childPosition);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        return getGenericView(colleges.get(groupPosition).getMajorName());
    }
    ...
    public ExpandableListView getGenericExpandableListView(SelectMajorBean college){
        ...
        // 加载班级的适配器
        ZiChildExpandableListViewAdapter adapter = new ZiChildExpandableListViewAdapter(college.getChild(),activity);
