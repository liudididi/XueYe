...
public class Gv_addressAdapter extends BaseAdapter {
    ...
    public Gv_addressAdapter(List<String> list, Context context) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            convertView=View.inflate(context, R.layout.adress_item,null);
        }
