...
public class JobXiaoAdapter extends BaseAdapter {

    private List<MoreJobBean.JobListTwoBean>  list;
    private Context context;

    public JobXiaoAdapter(List<MoreJobBean.JobListTwoBean> list, Context context) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        JobSanAdapter benSanAdapter=new JobSanAdapter(list.get(position).getJobListThree(),context);
        ...
        xiao_tv.setText(list.get(position).getClassifytwoName());
        return convertView;
    }
