...
public class ZiChildExpandableListViewAdapter extends BaseExpandableListAdapter {


    // 班级的集合
    private List<SelectMajorBean.ChildBeanX> classes;

    // 创建布局使用
    private Activity activity;


    public ZiChildExpandableListViewAdapter(List<SelectMajorBean.ChildBeanX> classes, Activity activity) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        return getGenericView(classes.get(groupPosition).getMajorName());
    }

    @Override
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        View genericView = getGenericView(classes.get(groupPosition).getChild().get(childPosition).getMajorName());
