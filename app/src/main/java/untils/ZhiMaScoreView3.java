...
public class ZhiMaScoreView3 extends View {
    ...
    public ZhiMaScoreView3(Context context)
    {
        super(context);
    ...
    public ZhiMaScoreView3(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public ZhiMaScoreView3(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    protected void drawPoint(Canvas canvas)
    {
        ...
        for(int i = 0; i < scorePoints.size(); i++)
        {
            ...
            brokenPaint.setStyle(Paint.Style.FILL);
                ...
                //绘制浮动文字
                canvas.drawText(String.valueOf(listfen.get(i).intValue()), scorePoints.get(i).x, scorePoints.get(i).y - dipToPx(5f) - textSize/2, textPaint);
