...
/**
 * Created by 地地 on 2018/2/6.
 * 邮箱：461211527@qq.com.
 */

public class ZhiMaScoreView2 extends View {
    ...
    private int brokenLineColor   = 0xffeaeaea;//0xff02bbb7
    private int straightLineColor = 0xffeaeaea;//0xffeaeaea
    private int textNormalColor   = Color.GREEN;
    ...
    private String[] monthText = new String[]{" ", " "," "," "," "};
    ...
    public ZhiMaScoreView2(Context context)
    {
        super(context);
    ...
    public ZhiMaScoreView2(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public ZhiMaScoreView2(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    private void initConfig(Context context, AttributeSet attrs)
    {
        ...
        minScore=a.getInt(R.styleable.ZhiMaScore_min_score,500);
        brokenLineColor=a.getColor(R.styleable.ZhiMaScore_broken_line_color,Color.parseColor("#3E58FF"));
    ...
    public void setlistfen(List<Integer> newlistfen){

        this.listfen=newlistfen;
    }
    ...
    private void initData()
    {
        ...
        for(int i = 0; i < listfen.size(); i++)
        {
            ...
            point.x = coordinateX;
            if(listfen.get(i)> maxScore)
            {
                maxScore = listfen.get(i).intValue();

            }
            else if(listfen.get(i) < minScore)
            {

                minScore =listfen.get(i).intValue();

            }
            point.y = (int) (((float) (maxScore - listfen.get(i).intValue()) / (maxScore - minScore)) * (minScoreYCoordinate - maxScoreYCoordinate) + maxScoreYCoordinate);
...
/*
    ...
    protected void drawPoint(Canvas canvas)
    {
        ...
        for(int i = 0; i < scorePoints.size(); i++)
        {
            ...
            brokenPaint.setStyle(Paint.Style.STROKE);
            canvas.drawCircle(scorePoints.get(i).x, scorePoints.get(i).y, dipToPx(1), brokenPaint);
            ...
            brokenPaint.setStyle(Paint.Style.FILL);
                ...
                canvas.drawCircle(scorePoints.get(i).x, scorePoints.get(i).y, dipToPx(2f), brokenPaint);
                //绘制浮动文本背景框
               // drawFloatTextBackground(canvas, scorePoints.get(i).x, scorePoints.get(i).y - dipToPx(8f));
                textPaint.setColor(Color.RED);
                //绘制浮动文字
               canvas.drawText(String.valueOf(listfen.get(i).intValue()), scorePoints.get(i).x, scorePoints.get(i).y - dipToPx(5f) + 2*textSize, textPaint);
