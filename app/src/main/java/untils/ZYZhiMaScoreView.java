...
public class ZYZhiMaScoreView extends View {
    ...
    public ZYZhiMaScoreView(Context context)
    {
        super(context);
    ...
    public ZYZhiMaScoreView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public ZYZhiMaScoreView(Context context, AttributeSet attrs, int defStyleAttr)
    {
