...
public class ZhiMaScoreViewXinzi extends View {
    ...
    private String[] monthText = new String[]{"应届生", "1年","2年", "3年","4年","5年"};
    ...
    public ZhiMaScoreViewXinzi(Context context)
    {
        super(context);
    ...
    public ZhiMaScoreViewXinzi(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public ZhiMaScoreViewXinzi(Context context, AttributeSet attrs, int defStyleAttr)
    {
