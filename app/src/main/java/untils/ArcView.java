...
public class ArcView extends View {
    ...
    //颜色 默认的颜色
    private int[] mColors = {
            Color.parseColor("#5e9cf3"),
            Color.parseColor("#73aeff"),
            Color.parseColor("#a1c9ff"),
            Color.parseColor("#c3ddff"),
            Color.parseColor("#ddebff"),
            Color.parseColor("#ebf4ff")
    };
    ...
    private void drawLineAndText(Canvas canvas) {
        ...
        //画其他
      /*  if (start < 359)
            drawLine(canvas, start, 360 - start, "", Color.parseColor("#73aeff"));*/
    ...
    private void drawLine(Canvas canvas, int start, float angles, String text, int color) {
        ...
        int endX;
        if (stopX > 0) {
            endX = (centerX - getPaddingRight() - 200);
        } else {
            endX = (-centerX + getPaddingLeft() + 200);
        }
        //画横线
    ...
    private void drawCircle(Canvas canvas) {
        ...
        mPaint.setColor(Color.parseColor("#73aeff"));
      //  canvas.drawArc(rect, start, angles, true, mPaint);
